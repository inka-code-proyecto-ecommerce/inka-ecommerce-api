...
class HomeController extends Controller
{
    ...
    public function filter_advance_product(Request $request)
    {
        ...
        $products = Product::filterAdvanceEcommerce($categories_selected, $colors_product_selected, $brands_selected, $min_price, $max_price, $currency, $product_general_ids_array, $options_aditional,$search)->orderBy("id", "desc")->get();
