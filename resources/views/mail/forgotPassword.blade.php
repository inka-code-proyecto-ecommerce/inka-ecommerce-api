                          ...
                          <tr>
                            ...
                            >
                              ...
                              ><span
                                  class="link c-grey"
                                  style="text-decoration:none; color:#6e6e6e;"
                                >View this email in your browser</span></webversion>
                            </td>
                          </tr>
                        </table> <!-- END Top -->
                                              ...
                                              >
                                                ...
                                                >
                                                  ...
                                                  <tr>
                                                    ...
                                                    >
                                                      <multiline>
                                                        Click on the button below to activate code, this is your
                                                        requested account key code to log in with your email address
                                                        (name@mail.com)
                                                      </multiline>
                                                    </td>
                                                  </tr>
                                                  <tr>
                                                    ...
                                                    >
                                                      ...
                                                      >
                                                        <tr>
                                                          <td
                                                            class="title-22 a-center px-50 mpx-15 py-20"
                                                          ...
                                                          >
                                                            <multiline>
                                                              <strong>USE CODE : <span
                                                                  class="c-purple"
                                                                  style="color:#9128df;"
                                                                >{{ $user->code_verified }}</span></strong>
                                                            </multiline>
                                                          </td>
                                                        </tr>
                                                      </table>
                        ...
                        >
                          <tr>
                            ...
                            >
                              ...
                              ><span
                                  class="link c-grey"
                                  style="white-space: nowrap; text-decoration:none; color:#6e6e6e;"
                                >UNSUBSCRIBE</span></unsubscribe> &nbsp;|&nbsp; <webversion
                                class="link c-grey"
                                style="text-decoration:none; color:#6e6e6e;"
                              ><span
                                  class="link c-grey"
                                  style="white-space: nowrap; text-decoration:none; color:#6e6e6e;"
                                >WEB VERSION</span></webversion> &nbsp;|&nbsp; <forwardtoafriend
                                class="link c-grey"
                                style="text-decoration:none; color:#6e6e6e;"
                              ><span
                                  class="link c-grey"
                                  style="white-space: nowrap; text-decoration:none; color:#6e6e6e;"
                                >SEND TO A FRIEND</span></forwardtoafriend>
                            </td>
                          </tr>
                        </table> <!-- END Bottom -->
                      </td>
